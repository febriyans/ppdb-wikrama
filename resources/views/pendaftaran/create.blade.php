                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" id="textarea" class="form-control">{{ old('alamat') }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="asal_sekola">Asal Sekolah</label>
                                    <input type="text" name="asal_sekola" class="form-control" value="{{ old('asal_sekola') }}" required>
